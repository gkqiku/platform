...
<script lang="ts">
  ...
  import { ReduceContext, addTxListener, contextStore, getClient, reduceCalls } from '@hcengineering/presentation'
  ...
  const updatePreviewPresenter = reduceCalls(async function (ctx: ReduceContext, doc?: Doc): Promise<void> {
